    ...
    public partial class DBCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Units", t => t.Unit_FK)
                ...
                c => new
                    {
                        ...
                        Goods_FK = c.Int(nullable: false),
                        Numbers = c.Int(nullable: false),
                        Price = c.Double(nullable: false),
                    })
                .PrimaryKey(t => t.OrderDetailsId)
                .ForeignKey("dbo.Goods", t => t.Goods_FK)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Goods", "AppUser_FK", "dbo.AppUsers");
            ...
            DropForeignKey("dbo.Goods", "PurchaseInvoice_FK", "dbo.PurchaseInvoicies");
            DropForeignKey("dbo.PurchaseInvoicies", "Unit_FK", "dbo.Units");
            DropForeignKey("dbo.ProductList", "UnitId_FK", "dbo.Units");
            DropForeignKey("dbo.Goods", "Unit_FK", "dbo.Units");
            DropForeignKey("dbo.PurchaseInvoicies", "ProductList_FK", "dbo.ProductList");
            DropForeignKey("dbo.Goods", "ProductList_FK", "dbo.ProductList");
            DropForeignKey("dbo.OrderDetails", "Goods_FK", "dbo.Goods");
            ...
            DropIndex("dbo.OrderDetails", new[] { "Goods_FK" });
            DropIndex("dbo.OrderDetails", new[] { "Orders_FK" });
            DropIndex("dbo.Goods", new[] { "AppUser_FK" });
            DropIndex("dbo.Goods", new[] { "Unit_FK" });
            DropIndex("dbo.Goods", new[] { "PurchaseInvoice_FK" });
            DropIndex("dbo.Goods", new[] { "ProductList_FK" });
            DropIndex("dbo.PurchaseInvoicies", new[] { "AppUser_FK" });
            DropIndex("dbo.PurchaseInvoicies", new[] { "Unit_FK" });
            DropIndex("dbo.PurchaseInvoicies", new[] { "Saller_FK" });
            DropIndex("dbo.PurchaseInvoicies", new[] { "ProductList_FK" });
